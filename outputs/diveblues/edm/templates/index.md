...
| `DB-EDM-EXP-20260625-WELCOME-NEWSLETTER-V1` | 2026-06-25 | Diveblues | newsletter / welcome subscription | exploration | New subscriber welcome template exploration | `outputs/diveblues/edm/templates/2026-06-25-explore-newsletter-welcome-v1.liquid` | `customer.first_name`, `unsubscribe_url`, `open_tracking` | One-image hero, personalized greeting, welcome copy, newsletter expectation block, single CTA, reusable Diveblues footer/contact constants, dark-mode cues | `customer.first_name` default, image alt text, solid bgcolor, live text, visible unsubscribe and physical address | one approved Shopify Files URL | `all_products[handle]`: not used; `customer.accepts_marketing`: not used | Pending: Gmail / Outlook / Apple Mail / mobile / dark mode | Welcome flow CTR, unsubscribe, conversion, RPE, qualitative QA notes; open rate auxiliary only | 测试中 | Candidate only. CTA points to all-products collection. Open tracking enabled. |
